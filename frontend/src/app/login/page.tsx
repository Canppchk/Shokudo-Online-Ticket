                        ...
                        <div className="p-6 space-y-4 mx-auto">
                            ...
                            <form className="space-y-4 md:space-y-7 " action="#">
                                <div>
                                    ...
                                    <input name="email"  className="bg-gray-50 border border-black text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " 
                                    id="email"
                                    type="text"
                                    value={user.email}
                                ...
                                <div>
                                    ...
                                    <input name="password" className="bg-gray-50 border border-black text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" 
                                    id="password"
                                    type="password"
                                    value={user.password}
                                ...
                                <button type="submit" className="w-full text-white bg-spgreen hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign in</button>
                                </div>
